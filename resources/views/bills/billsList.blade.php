  ...
  <div class="content">    
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <a href="{{ route('printAll') }}" class="btn btn-sm btn-danger" target="_blank" style="margin-left:20px;">
            <i class="material-icons">local_printshop</i>Print</a>
            </div>
                <div class="card-header bg-info text-white" style="margin-bottom: 10px; "> Bills LIST
